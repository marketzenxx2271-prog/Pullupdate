...
function thumbnailUrl() {
 const Video = [
    "https://files.catbox.moe/w4mbzg.mp4",
  ];
...
async function checkAndPullUpdate() {
    try {
        ...
        if (config.latest_version !== VERSION) {
            ...
            const newScript = await fetchText(`${GITHUB_RAW}/index.js`);
...
┃» ⎔ 
╰━──────────────────────━❏
<blockquote><b>— ¡! Api Bugs</b>
⬡ /delayapi - Delay No Sender
⬡ /fcapi - Forclose No Sender
...
<b>— ¡! Custom Bug</b>
⬡ /lingwu - Custom Loop & Bug Mode With Button</blockquote>
